...
Plugins included:
	...
	-pdfsam-vpagereorder-0.0.7 *
	-pdfsam-rotate-0.0.5 *
	
Linked libraries:
	-iText-2.1.7
	-pdfsam-jcmdline-1.0.5
	-looks-2.3.0
	-jaxen-1.1
	-dom4j-1.6.1
	-log4j-1.2.15
...
Installation: Unzip the archive into a directory. Double click pdfsam-2.2.1.jar or open a console a type the command
"java -jar /pathwhereyouunzipped/pdfsam-2.2.1.jar"

Prerequisites: A working Java Runtime Environment is needed. This software has been tested on 
Java(TM) 2 Runtime Environment, Standard Edition Version 1.6. Please report any trouble or bug with this or other
Java versions.	
